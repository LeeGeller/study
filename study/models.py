...
class UserTestAssignment(models.Model):
    ...
    users_test = models.ForeignKey('study.Tests', on_delete=models.CASCADE, related_name='assigned_tests', verbose_name='Тест')
...
def update_question_count(self, instance, **kwargs):
    test = instance.test
    test.question_count = test.question_count.count()
    test.save()